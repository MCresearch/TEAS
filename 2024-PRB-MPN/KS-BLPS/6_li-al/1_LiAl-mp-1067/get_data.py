...
class Abacus:
    def __init__(self):
        ...
        self.ecut = 45 # in Ry
        self.k = [20]
        self.pseudo = {'Li':'li.gga.psp.1', 'Mg':'mg.gga.psp', 'Al':'al.gga.psp'}
        self.natom = {'Li':8, 'Al':8}
        self.id = ['Li','Al']
        # self.id = ['Li'] * self.natom['Li'] + ['Al'] * self.natom['Al']
        self.zatom = {'Li':3, 'Mg':12, 'Al':13}
        self.N = 11
        # self.create_files()
        # self.cal_e_v()
