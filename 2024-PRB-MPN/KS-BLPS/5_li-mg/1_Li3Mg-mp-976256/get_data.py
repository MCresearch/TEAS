...
class Abacus:
    def __init__(self):
        ...
        self.ecut = 45 # in Ry
        self.k = [12]
        self.pseudo = {'Li':'li.gga.psp.1', 'Mg':'mg.gga.psp'}
        self.natom = {'Li':12, 'Mg':4}
        self.id = ['Li','Mg']
        # self.id = ['Li'] * self.natom['Li'] + ['Mg'] * self.natom['Mg']
        self.zatom = {'Li':3, 'Mg':12}
        self.N = 11
        # self.create_files()
        # self.cal_e_v()
