...
mpirun -n 16 /home/mhchen_pkuhpc/mhchen_coe/lustre2/1_sunliang/2_software/abacus-3.7/abacus-develop/build/abacus > ../log/{0} && echo \"{0} done\"\n".format(self.structures[i] + str(j)))
...
if __name__ == '__main__':
    stru = []
    # stru_dir = "/home/mhchen_pkuhpc/mhchen_coe/lustre2/1_sunliang/1_work/9_mlkedf/0_generate_data/2_ks-pbe/0_data_set/b_wurtzite/0_structures/"# "/home/xianyuer/data/1_sunliang/1_work/0_ml_kedf/1_test/0_generate_data/2_ks-pbe/0_data_set/b_wurtzite/0_structures/"
