...
class Profess:
    def __init__(self):
        ...
        self.a = [
            5.46875734633189036771,
            4.82226791798097309538,
            3.84703418703668997836,
            6.66023456156792104110,
            3.88692630181348919294,
            3.08019345333892680117,
            2.76173117394769640498,
            2.52751523894334972908,
        ]
        ...
        self.id = 'Si'
        self.N = 1
        self.hcla = [0.01, 0.0055, 0.01, 0.01, 0, 0, 0, 0.003]
        self.create_files()
        self.cal_e_v()

    def create_inpt(self, inptfile, hcla):
        ...
        with open('jobs', 'w') as job:
            for i in range(len(self.structures)):
                for j in range(self.N):
                    ...
                    os.mkdir(path)
                    self.create_inpt(path+'/'+self.id+'.inpt', self.hcla[i])
