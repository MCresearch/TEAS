...
class Profess:
    def __init__(self):
        ...
        self.structures = ['fcc']
        self.constands = [[4.117335730505050],
                          [4.125206063637719],
                          [4.085519116576527],
                          [4.078382570601303],
                          [4.079187141621355],
        ...
        self.pseudo = ['mg.lda.recpot', 'al.lda.recpot']
        ...
        self.work_dir = "/home/dell/1_work/TKK_abacus/5_MgAl_alloy/2_bulk_properties/2_tkk/2_get_data"
        self.id = ['Mg', 'Al', 'Al', 'Al']
        self.N = 11
