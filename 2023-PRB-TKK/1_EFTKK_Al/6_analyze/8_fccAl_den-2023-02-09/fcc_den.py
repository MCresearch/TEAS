...
class PROFESS:
    def __init__(self):
        ...
        for i in range(len(sheets)):
            ...
            self.constants[i] = 3.970105290484439
        ...
        # self.cell = [np.array([[1/2**0.5, 0, 0], [0, 1/2**0.5, 0], [0, 0, 5]]),
        #              np.array([[1/2**0.5, 0, 0], [0, 1, 0], [0, 0, 2**0.5/4*14]]),
        #              np.array([[1/2**0.5, 0, 0], [1/2**0.5/2, 1/2**0.5/2*3**0.5, 0], [0, 0, 3**0.5/3*10]])]
        # self.position = [np.array([[0, 0, 0], [0.5, 0.5 ,0.1], [0, 0, 0.2], [0.5, 0.5, 0.3], [0, 0, 0.4]]),
        #                  np.array([[0, 0, 0], [0.5, 0.5 ,1/14], [0, 0, 2/14], [0.5, 0.5, 3/14], [0, 0, 4/14], [0.5, 0.5 ,5/14], [0, 0, 6/14]]),
        #                  np.array([[0, 0, 0], [1/3, 1/3, 0.1], [2/3, 2/3, 0.2], [0, 0, 0.3], [1/3, 1/3, 0.4]])]
        self.structures = ['fcc']
        self.cell = [np.array([[1, 0, 0], [0, 1, 0], [0, 0, 1]])]
        self.position = [np.array([[0, 0, 0], [0.5, 0.5 ,0], [0.5, 0, 0.5], [0, 0.5, 0.5]])]
        ...
        self.work_dir = "/home/dell/1_work/TKK_abacus/1_EFTKK_Al/6_analyze/8_fccAl_den-2023-02-09"
        self.id = 'Al'
        ...
        os.chdir(self.work_dir)
        self.workbook.save('energy_diff-2023-02-08.xls')
