...
class Abacus:
    def __init__(self):
        ...
        self.structures = ['cd', 'btin','fcc', 'bcc', 'hcp', 'sc']
        self.a = [5.408543163224102, 4.752412941002936, 3.8587830799369325, 3.0802588345439395,2.729216814764073, 2.4922597732684624]
        self.covera = [1, 2.592632187455004/4.752412941002936, 1, 1, 1.59270728861, 1]
    ...
    def create_INPUT(self, path, smearing):
        ...
        with open('jobs', 'w') as job:
            ...
            for i in range(len(self.structures)):
                for j in range(self.N):
                    ...
                    os.mkdir(path)
                    self.create_INPUT(path, self.smearing[i])
