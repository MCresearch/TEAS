...
class Abacus:
    def __init__(self):
        self.abacus = "/home/dell/1_work/0_ABACUS_DEVELOP/build-intel/abacus"
        self.bohr2a = 0.529177249
        # self.ry2ev = "13.6056923"
        self.structures = ['hd', 'cbcc','bct']
        self.a = [3.7999674195474435, 
                #   5.194174936740699, 
                #   5.44,
                  6.57,
                  3.3308217748370796]
        self.covera = [1.656, 1., 1.8276]
