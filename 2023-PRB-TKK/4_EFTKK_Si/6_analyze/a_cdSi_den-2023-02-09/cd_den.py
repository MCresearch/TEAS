...
class PROFESS:
    def __init__(self):
        ...
        self.position = [np.vstack([np.array([[0, 0, 0], [0.5, 0.5 ,0], [0.5, 0, 0.5], [0, 0.5, 0.5]]), np.array([[0, 0, 0], [0.5, 0.5 ,0], [0.5, 0, 0.5], [0, 0.5, 0.5]]) + 0.25])]
        ...
        self.work_dir = "/home/dell/1_work/TKK_abacus/4_EFTKK_Si/6_analyze/a_cdSi_den-2023-02-09"
        self.id = 'Si'
