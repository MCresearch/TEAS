...
class PROFESS:
    def __init__(self):
        ...
        self.data_file = '/home/dell/1_work/TKK_abacus/4_EFTKK_Si/6_analyze/2_bulk_properties/2_get_data/HC_data.xls'
        ...
        self.work_dir = "/home/dell/1_work/TKK_abacus/4_EFTKK_Si/6_analyze/3_surface_energy"
        self.id = 'Si'
        ...
        self.ground_e = self.ground_energies[0]
        self.a = self.constants[0]
